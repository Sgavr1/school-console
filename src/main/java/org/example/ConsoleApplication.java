...
public class ConsoleApplication {
    private final static String STRING_CHOOSE_COMMAND = "Choose a command: ";
    ...
    public void start() {
        while (true) {
            for (Map.Entry<Integer,Command> command : commands.entrySet()) {
                System.out.println(command.getKey() + ": " + command.getValue().commandName());
            }

            System.out.println("0: " + COMMAND_EXIT);
            System.out.print(STRING_CHOOSE_COMMAND);
